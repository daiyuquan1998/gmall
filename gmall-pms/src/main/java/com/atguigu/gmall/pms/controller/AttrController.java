...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttrsByCidOrTypePage(QueryCondition queryCondition,@RequestParam("cid")Long cid,
                                                  @RequestParam(value = "type",required = false)Integer type){
        PageVo pagevo =  attrService.queryAttrsByCidOrTypePage(queryCondition,cid,type);
